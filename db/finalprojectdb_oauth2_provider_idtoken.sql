...
CREATE TABLE `oauth2_provider_idtoken` (
  ...
  KEY `oauth2_provider_idtoken_user_id_dd512b59_fk_api_user_id` (`user_id`),
  CONSTRAINT `oauth2_provider_idto_application_id_08c5ff4f_fk_oauth2_pr` FOREIGN KEY (`application_id`) REFERENCES `oauth2_provider_application` (`id`),
  CONSTRAINT `oauth2_provider_idtoken_user_id_dd512b59_fk_api_user_id` FOREIGN KEY (`user_id`) REFERENCES `api_user` (`id`)
